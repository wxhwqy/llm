export const config = {
  ...
  summaryCompressTrigger: parseFloat(process.env.SUMMARY_COMPRESS_TRIGGER || "0.9"),
  summaryCompressRatio: parseFloat(process.env.SUMMARY_COMPRESS_RATIO || "0.7"),
  summaryCompressTimeout: parseInt(process.env.SUMMARY_COMPRESS_TIMEOUT || "30000", 10),
